...
// exposant = 5 → had exposant (ch7al mn marra ghandarbo)
// Had l code kay7sb: N ^ exp = 2 ^ 5 = 2 × 2 × 2 × 2 × 2 = 32
let result = N
let i = 1
// Nbdaw mn 1 7it deja 3andna nb ^ 1 f result
// Ghanwaslo l exposant bach n9asdo nb ^ exposant
while(i< exposant){
// while: Boucle li katb9a t3awd htta condition wali false
